...
###############################################################################
## Code to simulate GWAS SNP variants + covariates: Normal error terms
###############################################################################
...
# folder to hold datasets with normal errors
f1 <- "Normal_Errors/"
...
saveRDS(Sim, paste(f1, "Sim_", tx[runID], "_", n_tx[runID], "_", rep[1], 
  sep = ""))
...
saveRDS(Sim, paste(f1, "Sim_", tx[runID], "_", n_tx[runID], "_", seed[1], 
                   ".rds", sep = ""))
