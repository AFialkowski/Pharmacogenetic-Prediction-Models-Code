###############################################################################
## Code to summarize model results with small tx effects: Normal error terms
###############################################################################
...
for (i in 1:length(tx)) {
  ...
  saveRDS(Time0, paste(f1, "Time_EN1_cv_", tx[i], "_", n_tx[i], "_betas1.rds", 
    sep = ""))
...
for (j in 1:length(n_tx)) {
  ...
  write.table(y_sum, paste(f1, "Sum_y_", 2, "_", n_tx[j], "_betas1.txt", sep = ""), row.names = T, col.names = T, 
              sep = "\t", quote = F)
...
for (j in 1:length(n_tx)) {
  ...
  colnames(y) <- paste("y", 1:10000, sep = "")
  y_sum <- describe(y, quant = c(0.25, 0.75))
  write.table(y_sum, paste(f1, "Sum_y_", 3, "_", n_tx[j], "_betas1.txt", sep = ""), row.names = T, col.names = T, 
              sep = "\t", quote = F)
...
for (j in 1:length(n_tx)) {
  ...
  colnames(y) <- paste("y", 1:10000, sep = "")
  y_sum <- describe(y, quant = c(0.25, 0.75))
  write.table(y_sum, paste(f1, "Sum_y_", 5, "_", n_tx[j], "_betas1.txt", sep = ""), row.names = T, col.names = T, 
              sep = "\t", quote = F)
...
write.table(Sum_y, paste(f1, "Sum_y_betas1.txt", sep = ""), row.names = T, col.names = T, 
            sep = "\t", quote = F)
...
write.table(terr, paste(f1, "tx2_terr_betas_1.txt", sep = ""), col.names = T, row.names = F, 
            sep = "\t", quote = F)
...
terr <- as.data.frame(terr)
write.table(terr, paste(f1, "tx3_terr_betas_1.txt", sep = ""), col.names = T, row.names = F, 
            sep = "\t", quote = F)

terr <- NULL
tx <- rep(5, 3)
beta_tx <- c(0.5, -0.5, 0.75, -0.75)
n_tx <- c(100, 250, 500)
for (i in 1:length(n_tx)) {
  # Lasso
  pred <- list()
...
terr <- as.data.frame(terr)
write.table(terr, paste(f1, "tx5_terr_betas_1.txt", sep = ""), col.names = T, row.names = F, 
            sep = "\t", quote = F)
...
write.table(rmse, paste(f1, "rmse_betas_1.txt", sep = ""), col.names = T, row.names = F, 
            sep = "\t", quote = F)
...
colnames(rmse) <- c("Tx", "N_Tx", "Model", "RMSE", "R2")
rmse <- as.data.frame(rmse)
write.table(rmse, paste(f1, "train_rmse_betas_1.txt", sep = ""), col.names = T, row.names = F, 
            sep = "\t", quote = F)
...
write.table(pr_2, paste(f1, "nperc_pr_2_betas_1.txt", sep = ""), col.names = T, row.names = F, 
            sep = "\t", quote = F)
...
write.table(pr_3, paste(f1, "nperc_pr_3_betas_1.txt", sep = ""), col.names = T, row.names = F, 
            sep = "\t", quote = F)
...
write.table(pr_5, paste(f1, "nperc_pr_5_betas_1.txt", sep = ""), col.names = T, row.names = F, 
            sep = "\t", quote = F)
...
colnames(pr_2) <- c("Tx", "N_Tx", "Model", "fpr1", "fpr2", "fpr3", "tpr1", "tpr2", "tpr3")
pr_2 <- as.data.frame(pr_2)
write.table(pr_2, paste(f1, "npr_2_betas_1.txt", sep = ""), col.names = T, row.names = F, 
            sep = "\t", quote = F)
...
colnames(pr_3) <- c("Tx", "N_Tx", "Model", "fpr1", "fpr2", "fpr3", "tpr1", "tpr2", "tpr3")
pr_3 <- as.data.frame(pr_3)
write.table(pr_3, paste(f1, "npr_3_betas_1.txt", sep = ""), col.names = T, row.names = F, 
            sep = "\t", quote = F)
...
colnames(pr_5) <- c("Tx", "N_Tx", "Model", "fpr1", "fpr2", "fpr3", "tpr1", "tpr2", "tpr3")
pr_5 <- as.data.frame(pr_5)
write.table(pr_5, paste(f1, "npr_5_betas_1.txt", sep = ""), col.names = T, row.names = F, 
            sep = "\t", quote = F)
